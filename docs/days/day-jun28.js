  ...
  variants: [
    {
      ...
      items: [
        ...
        { time: '8:30am', text: 'Arrive Denali Bus Depot / Wilderness Access Center, check in for your reserved Transit Bus departure (book ahead at reservedenali.com; arrive 20 min early)' },
        ...
        { time: '1:30–2:00pm', text: 'Quick lunch at the Morino Grill, Denali Visitor Center' },
        { time: '2:00–3:00pm', text: 'Sled Dog Kennels demonstration (free shuttle from the Denali Visitor Center, 2:00pm show)' },
        ...
        { time: '6:30pm', text: 'Dinner at Lavelle’s Bistro' },
      ],
    },
  ],
};
