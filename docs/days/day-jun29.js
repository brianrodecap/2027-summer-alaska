  ...
  variants: [
    {
      ...
      items: [
        ...
        { time: '9:15–9:45am', text: 'Stop at Yukon River Camp (open 8:00am–11:30pm daily) — restrooms, coffee/snacks, photos of the Yukon River and the Trans-Alaska Pipeline' },
        ...
        { time: '1:30–4:30pm', text: 'Arctic Interagency Visitor Center — exhibits, bookstore, short nature trail to the Trans-Alaska Pipeline viewpoint (bring snacks for the afternoon, since the cafe is buffet-only at meal windows)' },
        { time: '5:00–6:00pm', text: 'Dinner buffet at Coldfoot Camp Cafe (5–9pm buffet window)' },
