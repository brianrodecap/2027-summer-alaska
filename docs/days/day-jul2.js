  ...
  variants: [
    {
      ...
      items: [
        ...
        { time: '3:00–4:00pm', text: 'Wrangell–St. Elias National Park Visitor Center (open 9am–5pm daily) — exhibits, relief model of the park, ranger talk if one’s scheduled' },
        { time: '4:15–5:00pm', text: 'George I. Ashby Memorial Museum (hours found were inconsistent across sources — worth a quick call ahead; historic log cabins with early mining and Russian artifacts)' },
        { time: '6:30pm', text: 'Dinner at Two Rivers Restaurant (or the more casual Whistle Stop Bar & Grill), both at the lodge' },
      ],
      footer:
