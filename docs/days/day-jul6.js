  ...
  variants: [
    {
      ...
      items: [
        ...
        { time: '11:30am', text: 'Check in with Golden Eagle Outfitters at their hangar near the Alaska terminal — let them know you’re in town; since they fly in queue order as conditions allow, there’s a real chance of getting the Kobuk Valley flight in this same afternoon', place: { id: 'ChIJ9-Ij5lkXzVARObCKEwG8c1I', label: 'Golden Eagle Outfitters' } },
        ...
        { time: '1:00–3:00pm (if no flight)', text: 'Northwest Arctic Heritage Center, walk Shore Avenue along the lagoon', place: { id: 'ChIJg65tX1cXzVAR9z2Gr7xJSN4', label: 'Northwest Arctic Heritage Center' } },
